...
load(paste(base_folder, "results", "r07_pick_egenvectors_exclude_outliers_wecare_only.RData", sep="/"))
#base_folder="/analysis/mtgroup_share/users/alexey/wecare_only_stat_05.17"
...
save.image(paste(base_folder, "results", "r08_filter_by_variant_effect_wecare_only.RData", sep="/"))
