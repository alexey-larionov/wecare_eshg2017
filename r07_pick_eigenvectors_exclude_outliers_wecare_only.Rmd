...
load(paste(base_folder, "results", "r05_calculate_egenvectors_wecare_only.RData", sep="/"))
#base_folder="/analysis/mtgroup_share/users/alexey/wecare_only_stat_05.17"
...
wecare_wes_phenotypes.df <- read.table(paste(base_folder, "results", "r03_wecare_phenotypes_interim.txt", sep="/"), 
...
write.table(wecare_wes_phenotypes.df, file=paste(base_folder, "results", "r07_wecare_phenotypes.txt", sep="/"), quote=FALSE, sep="\t")
...
save.image(paste(base_folder, "results", "r07_pick_egenvectors_exclude_outliers_wecare_only.RData", sep="/"))
